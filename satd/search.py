...
class Feature:
    ...
    def __str__(self):
        return f"({self.properties['datetime']}) thumbnail: {self.quicklook_href}"

class FeatureCollection:
    def __init__(self, data):
        self.data = data
        self.features = [
            Feature(f) for f in self.data["features"]
        ]
...
def search(bbox=[12.41, 41.80, 12.52, 41.90], time_range="2022-01-01/2022-03-01", sensor="SENTINEL-2"):
